...
ridge_model= pickle.load(open('E:/Pregrade/Project_August/Algerian_Forest/Model/ridge.pkl','rb'))
scaler = pickle.load(open('E:/Pregrade/Project_August/Algerian_Forest/Model/scaler.pkl' ,'rb'))
